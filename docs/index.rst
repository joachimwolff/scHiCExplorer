...
scHiCExplorer is available as a **command line suite of tools** on this `GitHub repository <https://github.com/joachimwolff/scHiCExplorer>`_. scHiCExplorer is a general use single-cell Hi-C analysis software, 
